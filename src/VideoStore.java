...
public class VideoStore {
	...
	public static void main(String[] args) {
		...
		//prove singleton VIP customer
		System.out.println("");
		cust = SingletonVIPCustomer.getInstance();
		cust = SingletonVIPCustomer.getInstance();
		cust = SingletonVIPCustomer.getInstance();

		// Introduce customer factory
		System.out.println("");
		CustomerFactory factory = new CustomerFactory();
		factory.createCustomer("normal");
		factory.createCustomer("vip");
		factory.createCustomer("singleton");

		//Iterator customer list
		System.out.println("");
		while (myStore.customerList.hasNext()){
			System.out.println(myStore.customerList.next());
		}
		//Iterator video list
		while (myStore.customerList.hasNext()){
			System.out.println(myStore.videoList.next());
		}
